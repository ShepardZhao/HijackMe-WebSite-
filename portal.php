...
<div class="row verticalAndHorCenter">
    <div class="row text-center">
        <div class="large-4 columns small-12 text-center" id="portal1">
        ...
        <div class="large-4 columns small-12 text-center" id="portal3">
        ...
        <div class="large-4 columns small-12 text-center" id="portal2">
            <a class="hide-for-small-only" href="faceDectection_camera.php" data-reveal-id="video_modal" data-reveal-ajax="true" ><img  src="assets/img/faceLogin.png"><br><h5 class="color_white">Login by FaceDectection</h5></a>
        </div>
    </div>
